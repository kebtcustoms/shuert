...
<div class="footcontainer">
  <div class="footer">
    <div class="footercontainer">
      ...
      <div class="footerel" on:click={() => goto(`/products`)}>Products</div>
       <!-- svelte-ignore a11y-click-events-have-key-events -->
      <!-- svelte-ignore a11y-no-static-element-interactions -->
      
      <div class="footerel" on:click={() => goto(`/customdesign`)}>Custom Design</div>
       <!-- svelte-ignore a11y-click-events-have-key-events -->
      <!-- svelte-ignore a11y-no-static-element-interactions -->
      
      <div class="footerel" on:click={() => goto(`/shuertadvantage`)}>Shuert Advantage</div>
       <!-- svelte-ignore a11y-click-events-have-key-events -->
      <!-- svelte-ignore a11y-no-static-element-interactions -->
      <div class="footerel" on:click={() => goto(`/requestaquote`)}>Request a Quote</div>
      <!-- svelte-ignore a11y-click-events-have-key-events -->
      <!-- svelte-ignore a11y-no-static-element-interactions -->
      <div class="footerel" on:click={() => goto(`/contact`)}>Contact Us</div>
    </div>
  </div>
