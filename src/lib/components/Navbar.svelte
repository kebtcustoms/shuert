...
/* 
    ...
    .bigmenu {
      ...
      pointer-events: none;
      transition: opacity 0.15s, background-color 0.3s, backdrop-filter 0.3s ease;
      left: 50%;
      top: 300px;
      transform: translate(-50%, -50%);
    }
    ...
    .open {
      ...
      transition: opacity 0.15s, background-color 0.15s ease;
  ...
  <div class="navbar">
    <div class="containerleft">
        ...
        <div class="logo" on:click={() => goto(`/`)}>
            <svg class="biglogo"  id="Layer_2" data-name="Layer 2" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 360.55 47">
                <defs>
                  <style>
                    .cls-1 {
                      fill: none;
            ...
            <svg class="smalllogo"  id="Layer_2" data-name="Layer 2" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 360.55 47">
                <defs>
                  <style>
                    .cls-1 {
                      fill: none;
        ...
        <!-- <div class="language-selector">
          <select bind:value={selectedLanguage} class="selectedlang">
    ...
    <div class="containerright">
        <div class="menu" on:click={() => isActive = !isActive}>
          <div class={isActive ? 'hamburger-menu rotate-right' : 'hamburger-menu'}></div>
          <div class={isActive ? 'hamburger-menu1 rotate-left' : 'hamburger-menu1'}></div>
            
            <p class="menutext">MENU</p>
        </div>
        <button class="requestbutton" on:click={() => goto(`/requestaquote`)}>Request a Quote</button>
    </div>
  </div>
  <div class={isActive ? "bigmenu open" : "bigmenu"}></div>