<script>
  ...
  function handleNavigation(path) {
    goto(path); // this should be your existing navigation function
...
<div class={isActive ? "bigmenu open" : "bigmenu"}>
  ...
  <div class="dropmenu">
    ...
    <div class={productActive ? "productmenu" : "productmenu closed"}>
      <!-- svelte-ignore a11y-click-events-have-key-events -->
      <h2 on:click={() => handleNavigation("/products/unipak")}>Uni-Pak</h2>
      <!-- svelte-ignore a11y-click-events-have-key-events -->
      <h2 on:click={() => handleNavigation("/products/unipallet")}>
        Uni-Pallet
      </h2>
      <!-- svelte-ignore a11y-click-events-have-key-events -->
      <h2 on:click={() => handleNavigation("/products/unidirectional")}>
        Uni-Directional
      </h2>
      <!-- svelte-ignore a11y-click-events-have-key-events -->
      <h2 on:click={() => handleNavigation("/products/unicase")}>Uni-Case</h2>
      <!-- svelte-ignore a11y-click-events-have-key-events -->
      <h2 on:click={() => handleNavigation("/products/unirak")}>Uni-Rak</h2>
      <!-- svelte-ignore a11y-click-events-have-key-events -->
      <h2 on:click={() => handleNavigation("/products/yarnpak")}>Yarn-Pak</h2>
      <!-- svelte-ignore a11y-click-events-have-key-events -->
      <h2 on:click={() => handleNavigation("/products/propak")}>Pro-Pak</h2>
      <!-- svelte-ignore a11y-click-events-have-key-events -->
      <h2 on:click={() => handleNavigation("/products/remanpak")}>Reman Pak</h2>
      <!-- svelte-ignore a11y-click-events-have-key-events -->
      <h2 on:click={() => handleNavigation("/products/batterypak")}>
        Battery Pak
      </h2>
    </div>
    <!-- svelte-ignore a11y-click-events-have-key-events -->
    <h1 on:click={() => handleNavigation("/customdesign")}>Custom Design</h1>
    <!-- svelte-ignore a11y-click-events-have-key-events -->
    <h1 on:click={() => handleNavigation("/shuertadvantage")}>
      The Shuert Advantage
    </h1>
    <!-- svelte-ignore a11y-click-events-have-key-events -->
