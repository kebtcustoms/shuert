<script>
    ...
    let productimage = "propak"

    let products = [
        {
            id: "pro-pak",
            name: "Pro-Pak",
            svg: `<svg id="Layer_2" data-name="Layer 2" xmlns="http://www.w3.org/2000/svg" height="166" viewBox="0 0 198.84 166">
  <defs>
    <style>
      .cls-1 {
        fill: none;
...
`,
    ...
    let producttitle = "Pro-Pak"
    let productdesc = "Shuert Technologies has developed the industry’s most complete storage and shipping system for 20-pound propane cylinders. Each Pro-Pak system is comprised of a custom fitted pallet, divider, and ring to stabilize and secure cylinders in the transportation and storage mode. The interlocking design of the Pro-Pak provides improved safety and reduced over-all height for stable long-haul shipping. "
</script>
