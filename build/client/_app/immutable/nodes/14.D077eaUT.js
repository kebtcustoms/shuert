import{s as y,n as U}from"../chunks/scheduler.NS8L8LGm.js";import{S as x,i as S,m as f,s as k,e as R,n as u,h as _,c as b,d as M,g as o,o as T,p as h,j as d,t as g,a as $,q as v}from"../chunks/index.OFbx2xAc.js";import{S as q,F as z}from"../chunks/Form.oILZ8vQZ.js";import{A,U as D,S as F}from"../chunks/Spacer.Cnxwt_mv.js";function L(w){let e,l,n,m,a,c,i,r,p;return e=new A({props:{productimage:Z,component:D,producttitle:j,productdesc:B}}),n=new F({}),a=new q({}),r=new z({props:{products:w[0]}}),{c(){f(e.$$.fragment),l=k(),f(n.$$.fragment),m=k(),f(a.$$.fragment),c=k(),i=R("div"),f(r.$$.fragment),this.h()},l(t){u(e.$$.fragment,t),l=_(t),u(n.$$.fragment,t),m=_(t),u(a.$$.fragment,t),c=_(t),i=b(t,"DIV",{style:!0});var s=M(i);u(r.$$.fragment,s),s.forEach(o),this.h()},h(){T(i,"margin-top","100px")},m(t,s){h(e,t,s),d(t,l,s),h(n,t,s),d(t,m,s),h(a,t,s),d(t,c,s),d(t,i,s),h(r,i,null),p=!0},p:U,i(t){p||(g(e.$$.fragment,t),g(n.$$.fragment,t),g(a.$$.fragment,t),g(r.$$.fragment,t),p=!0)},o(t){$(e.$$.fragment,t),$(n.$$.fragment,t),$(a.$$.fragment,t),$(r.$$.fragment,t),p=!1},d(t){t&&(o(l),o(m),o(c),o(i)),v(e,t),v(n,t),v(a,t),v(r)}}}let Z="unirak",j="Uni-Rak",B="Shuert Technologies presents the Uni-Rak – an innovative logistics solution revolutionizing the way automotive parts are transported. Designed with precision, the Uni-Rak offers unmatched protection for parts typically shipped in steel racks, from transmission components to electric vehicle motors. This modular and stackable design maximizes space efficiency and minimizes storage footprint, both in transit and within warehouse environments. The Uni-Rak's robust structure and reduced weight translate to lower shipping costs and decreased fuel consumption, supporting your sustainability goals while delivering a quick return on investment. Opt for Shuert Technologies' Uni-Rak for a smarter, safer, and more sustainable transportation of automotive parts.";function C(w){return[[{id:"uni-rak",name:"Uni-Rak",svg:`<svg id="Layer_2" data-name="Layer 2" xmlns="http://www.w3.org/2000/svg" height="125.01" viewBox="0 0 240 125.01">
  <defs>
    <style>
      .cls-1 {
        fill: none;
...
`,selected:!1}]]}class V extends x{constructor(e){super(),S(this,e,C,L,y,{})}}export{V as component};
