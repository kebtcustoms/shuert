import { c as create_ssr_component, g as add_attribute, f as each, e as escape, d as null_to_empty } from './ssr-DzG_XWZZ.js';
...
const css = {
  code: '@import url("/fonts.css");*{margin:0;padding:0;font-family:"Univers", sans-serif;box-sizing:border-box}.contacthero.svelte-19i8mpv.svelte-19i8mpv.svelte-19i8mpv{width:85%;margin:auto;display:flex;gap:50px;margin-bottom:70px;margin-top:120px}.contactheroleft.svelte-19i8mpv.svelte-19i8mpv.svelte-19i8mpv{width:50%;font-size:7em;line-height:1em;color:#f2f2f2;font-weight:bold}.boldtoday.svelte-19i8mpv.svelte-19i8mpv.svelte-19i8mpv{font-weight:bold}.contactheroright.svelte-19i8mpv.svelte-19i8mpv.svelte-19i8mpv{width:45%;margin:auto;font-size:2em;color:#f2f2f2}.boldnumber.svelte-19i8mpv.svelte-19i8mpv.svelte-19i8mpv{position:relative;font-weight:bold;color:#ce0024}.contactcontainer.svelte-19i8mpv.svelte-19i8mpv.svelte-19i8mpv{display:flex;gap:50px;width:85%;margin:auto}.contactright.svelte-19i8mpv.svelte-19i8mpv.svelte-19i8mpv{position:relative;width:100%}.contactform.svelte-19i8mpv.svelte-19i8mpv.svelte-19i8mpv{padding:50px;background-color:rgba(255, 255, 255, 0.047);border:#f2f2f21a solid 1px;border-radius:25px;display:flex;flex-wrap:wrap;flex-direction:column;gap:20px;box-shadow:0 0 20px rgba(0, 0, 0, 0.2);width:100%}.inputcontainer.svelte-19i8mpv.svelte-19i8mpv.svelte-19i8mpv{display:flex;flex-wrap:wrap;width:100%}.inputcontainer.svelte-19i8mpv>div.svelte-19i8mpv.svelte-19i8mpv{width:50%;display:flex;flex-direction:column;gap:20px}.inputcontainer.svelte-19i8mpv>div.svelte-19i8mpv>input.svelte-19i8mpv{width:95%}label.svelte-19i8mpv.svelte-19i8mpv.svelte-19i8mpv{font-size:1.5em;font-weight:100;margin-bottom:-10px;padding-top:20px;color:#f2f2f2}input.svelte-19i8mpv.svelte-19i8mpv.svelte-19i8mpv{border:none;padding:15px;border-radius:20px;font-size:1em;width:50%;background-color:rgba(255, 255, 255, 0.105);color:#f2f2f2}input.svelte-19i8mpv.svelte-19i8mpv.svelte-19i8mpv:focus{outline:none;border:#f2f2f21a solid 1px;font-size:1em}.svelte-19i8mpv.svelte-19i8mpv.svelte-19i8mpv::input-placeholder{font-size:1em}input.svelte-19i8mpv.svelte-19i8mpv.svelte-19i8mpv:-webkit-autofill::first-line,input.svelte-19i8mpv.svelte-19i8mpv.svelte-19i8mpv:-webkit-autofill,input.svelte-19i8mpv.svelte-19i8mpv.svelte-19i8mpv:-webkit-autofill:hover,input.svelte-19i8mpv.svelte-19i8mpv.svelte-19i8mpv:-webkit-autofill:focus,input.svelte-19i8mpv.svelte-19i8mpv.svelte-19i8mpv:-webkit-autofill:active{font-size:1em !important;font-family:"Univers", sans-serif !important;font-weight:200 !important}.productbuttonswrap.svelte-19i8mpv.svelte-19i8mpv.svelte-19i8mpv{display:flex;flex-direction:column;gap:15px;width:100%}.productbuttons.svelte-19i8mpv.svelte-19i8mpv.svelte-19i8mpv{display:flex;flex-wrap:wrap;gap:20px;margin-left:-5px}.productbuttoncont.svelte-19i8mpv.svelte-19i8mpv.svelte-19i8mpv{display:flex;flex-direction:column;align-items:center}.productbuttoncont.svelte-19i8mpv button.svelte-19i8mpv.svelte-19i8mpv{margin:5px;height:150px;width:150px;background-color:#f2f2f229;border:none;border-radius:10px;cursor:pointer;transition:background-color 0.3s ease;display:flex;justify-content:center;align-items:center}.productbuttoncont.svelte-19i8mpv button.active.svelte-19i8mpv.svelte-19i8mpv{background-color:#ce002218;color:#ce0024}.svg-container.svelte-19i8mpv.svelte-19i8mpv.svelte-19i8mpv{transform:scale(50%);cursor:pointer;stroke:#f2f2f2;transition:stroke 0.3s ease}.active-svg.svelte-19i8mpv.svelte-19i8mpv.svelte-19i8mpv{stroke:#ce0024;transform:scale(50%);cursor:pointer;transition:stroke 0.3s ease}.pcont.svelte-19i8mpv.svelte-19i8mpv.svelte-19i8mpv{color:#f2f2f2}.active-text.svelte-19i8mpv.svelte-19i8mpv.svelte-19i8mpv{color:#ce0024;transition:color 0.3s ease}textarea.svelte-19i8mpv.svelte-19i8mpv.svelte-19i8mpv{border-radius:20px;height:200px;padding:20px;font-size:18px;background-color:rgba(128, 128, 128, 0.105);border:none;color:#f2f2f2}textarea.svelte-19i8mpv.svelte-19i8mpv.svelte-19i8mpv:focus{outline:none;border:#f2f2f21a solid 1px}.contactbutton.svelte-19i8mpv.svelte-19i8mpv.svelte-19i8mpv{margin:auto;margin-top:30px;background-color:transparent;color:#f2f2f2;position:relative;width:200px;padding:10px;font-size:1.5em;font-weight:bold;border-radius:15px;border:1px solid #f2f2f2;transition:background-color 0.5s ease;cursor:pointer}.contactbutton.svelte-19i8mpv.svelte-19i8mpv.svelte-19i8mpv:hover{transition:background-color 0.5s ease;transition:border-color 0.1s ease;color:#f2f2f2;background-color:#ce0024;border:1px solid #ce0024}.thankYouAnimation.svelte-19i8mpv.svelte-19i8mpv.svelte-19i8mpv{position:absolute;top:0;left:0;width:100%;height:100%;background-color:rgba(56, 56, 56, 0.8);display:flex;justify-content:center;align-items:center;font-size:2em;font-weight:bold;color:white;opacity:0;animation:svelte-19i8mpv-fadeInOut 5s forwards;border-radius:20px}@keyframes svelte-19i8mpv-fadeInOut{0%{opacity:0}20%{opacity:1}80%{opacity:1}90%{opacity:0.5}100%{opacity:0}}@media(max-width: 950px){.contacthero.svelte-19i8mpv.svelte-19i8mpv.svelte-19i8mpv{flex-direction:column;margin-top:80px}.contactheroleft.svelte-19i8mpv.svelte-19i8mpv.svelte-19i8mpv{width:100%;text-align:center}.contactheroright.svelte-19i8mpv.svelte-19i8mpv.svelte-19i8mpv{width:100%;margin:auto;font-size:2em;color:#f2f2f2}.inputcontainer.svelte-19i8mpv>div.svelte-19i8mpv.svelte-19i8mpv{width:100%;display:flex;flex-direction:column;gap:20px}}@media(max-width: 498px){.inputcontainer.svelte-19i8mpv>div.svelte-19i8mpv>input.svelte-19i8mpv{width:100%}.inputcontainer.svelte-19i8mpv>div.svelte-19i8mpv.svelte-19i8mpv{width:90%;display:flex;flex-direction:column;text-align:left;gap:20px;margin:auto}.contactform.svelte-19i8mpv.svelte-19i8mpv.svelte-19i8mpv{padding-left:0px;padding-right:0px;margin:auto}.contacthero.svelte-19i8mpv.svelte-19i8mpv.svelte-19i8mpv{flex-direction:column;margin-top:80px}.contactheroleft.svelte-19i8mpv.svelte-19i8mpv.svelte-19i8mpv{width:100%;text-align:center;font-size:5em}.contactheroright.svelte-19i8mpv.svelte-19i8mpv.svelte-19i8mpv{font-size:1.8em}}@media(max-width: 330px){.contacthero.svelte-19i8mpv.svelte-19i8mpv.svelte-19i8mpv{flex-direction:column;margin-top:80px}.contactheroleft.svelte-19i8mpv.svelte-19i8mpv.svelte-19i8mpv{font-size:4.5em}.contactheroright.svelte-19i8mpv.svelte-19i8mpv.svelte-19i8mpv{font-size:1.5em}}',
  map: null
};
...
`,
  ...
  $$result.css.add(css);
  return `<main class="contactmain svelte-19i8mpv"><div class="contacthero svelte-19i8mpv" data-svelte-h="svelte-87z5wu"><div class="contactheroleft svelte-19i8mpv">Request a <span class="boldtoday svelte-19i8mpv">Quote</span></div> <div class="contactheroright svelte-19i8mpv">We appreciate your interest in learning how Shuert Technologies can
            help you find the right packaging solution for your project. Please
            use the form below or call <strong class="boldnumber svelte-19i8mpv">586-254-4590</strong> to discuss your needs with our team.</div></div> <div class="contactcontainer svelte-19i8mpv"><div class="contactright svelte-19i8mpv"><form class="contactform svelte-19i8mpv" method="POST"><div class="inputcontainer svelte-19i8mpv"><div class="svelte-19i8mpv"><label for="firstname" class="svelte-19i8mpv" data-svelte-h="svelte-1h2slvi">First Name</label> <input name="first" id="firstname" type="text" class="svelte-19i8mpv"${add_attribute("value", firstName, 0)}></div> <div class="svelte-19i8mpv"><label for="lastname" class="svelte-19i8mpv" data-svelte-h="svelte-1635pwo">Last Name</label> <input name="last" id="lastname" type="text" required class="svelte-19i8mpv"${add_attribute("value", lastName, 0)}></div> <div class="svelte-19i8mpv"><label for="companyname" class="svelte-19i8mpv" data-svelte-h="svelte-1k7jtck">Company Name</label> <input name="company" id="companyname" type="text" required class="svelte-19i8mpv"${add_attribute("value", companyName, 0)}></div> <div class="svelte-19i8mpv"><label for="email" class="svelte-19i8mpv" data-svelte-h="svelte-1p9d3fm">Email</label> <input name="email" id="email" type="email" required class="svelte-19i8mpv"${add_attribute("value", email, 0)}></div> <div class="svelte-19i8mpv"><label for="phone" class="svelte-19i8mpv" data-svelte-h="svelte-xjlanm">Phone</label> <input name="phone" id="Phone" type="tel" required class="svelte-19i8mpv"${add_attribute("value", phone, 0)}></div> <div class="svelte-19i8mpv"><label for="quantity" class="svelte-19i8mpv" data-svelte-h="svelte-1ognb32">Quantity</label> <input name="quantity" id="quantity" type="text" required class="svelte-19i8mpv"${add_attribute("value", quantity, 0)}></div></div> <div class="productbuttonswrap svelte-19i8mpv"><label for="products" id="products" class="svelte-19i8mpv" data-svelte-h="svelte-fsexl7">Products of Interest</label> <div class="productbuttons svelte-19i8mpv">${each(products, (product) => {
    return `<div class="productbuttoncont svelte-19i8mpv"><button type="button" class="${["svelte-19i8mpv", selectedProducts.includes(product) ? "active" : ""].join(" ").trim()}">   <div class="${escape(
      null_to_empty(selectedProducts.includes(product) ? "active-svg" : "svg-container"),
      true
    ) + " svelte-19i8mpv"}"> <!-- HTML_TAG_START -->${product.svg}<!-- HTML_TAG_END --> </div></button> <div class="${"pcont " + escape(selectedProducts.includes(product) ? "active-text" : "", true) + " svelte-19i8mpv"}">${escape(product.name)}</div> </div>`;
  })}</div></div> <label for="comments" class="svelte-19i8mpv" data-svelte-h="svelte-1cfsige">Comments</label> <textarea name="body" id="comments" class="svelte-19i8mpv">${escape("")}</textarea> <button type="submit" class="contactbutton svelte-19i8mpv" data-svelte-h="svelte-1a9a5h8">SUBMIT</button></form> ${``}</div></div> </main>`;
});

export { Page as default };
//# sourceMappingURL=_page.svelte-DPtnZDiV.js.map
